            ...
            <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
              ...
              <div className="hidden lg:block w-full duration-500 scroll-smooth">
                <div className="items-center flex duration-500 justify-end mx-auto gap-x-10">
                  ...
                  <div>
                    <a 
                      href="/login" className="items-center text-base md:hover:border-b bg-[#d8bb6c] border-[#d8bb6c] relative h-8 pt-0.5 duration-200 lg:px-10 md:px-6 px-4 flex justify-center flex-row text-[#fff] tracking-wide">
                      Login
                    </a>
                  </div>
                </div>
          ...
          {(ref) => (
            <div className="lg:hidden w-full pb-10 mt-3 bg-[#121212] text-white" id="mobile-menu">
              ...
              <a
                ...
                <div className=''>
                <a 
                  href="/login" className="text-[#d8bb6c] hover:bg-[#d8bb6c] hover:text-black border border-[#d8bb6c] mx-auto items-center relative h-10 mt-8 tracking-wider duration-200 px-4 w-full justify-center text-center flex rounded-sm">
                  Login
                 </a>
                </div>
              </div>
